...
//            
//=============================================================================
static const char *tags[] = { "󰼏", "󰼐", "󰼑", "󰼒", "󰼓", "󰼔","", "󰌳","󰼗","" };
...
//=============================================================================
    ...
    { MODKEY,           XK_grave, togglescratch, SHCMD("st -t scratchpad --class floatingTerminal")  }, // 打开/隐藏scrtachpad
    { MODKEY,              XK_Return,   spawn,   SHCMD("st") }, // 新打开一个终端
    { MODKEY|ShiftMask,    XK_n,        spawn,   SHCMD("st -t term-global --class globalingTerminal") }, // 新打开一个浮动终端
    { MODKEY,              XK_n,        spawn,   SHCMD("st -t term-float --class floatingTerminal") }, // 新打开一个全局浮动终端
